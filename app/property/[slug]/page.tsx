...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const properties = await getPropertiesBySlug(params.slug);
  ...
  const url = `${baseUrl}/property/${params.slug}`;
...
export default async function PropertyPage({ params }: PageProps) {
  ...
  const breadcrumbSchema = generatePropertyBreadcrumbSchema(params.slug, propertyName);
