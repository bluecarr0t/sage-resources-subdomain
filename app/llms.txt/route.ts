...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    `- [Glamping Market Data 2026](${baseUrl}/glamping-market-overview): Live US & Canada glamping supply, ARDR benchmarks, unit-type mix, and state rankings — Sage research (free magic-link access)`,
    `- [Top Glamping Brands 2026](${baseUrl}/glamping-market-overview/brands): Largest US glamping operators ranked by property count, units, and average nightly rates`,
    ...
    `- [Market research pages](${enBase}/markets): Indexable market landings (e.g. Colorado glamping) that deep-link into map filters for Organic entry—not SPA-only`,
