...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://resources.sageoutdooradvisory.com/images/gradient-3.jpg",
        width: 1920,
        height: 1080,
  ...
  twitter: {
    ...
    images: ["https://resources.sageoutdooradvisory.com/images/gradient-3.jpg"],
  },
  robots: {
    index: true,
    follow: true,
