...
type Props = {
  initialMeta: GlampingOverviewSnapshotMeta;
...
export default function GlampingIndustryOverviewCacheBar({
  initialMeta,
  snapshotInventory,
  rowsScannedTotal,
  rowsScannedHipcamp,
  ...
  const t = useTranslations('admin.glampingIndustryOverview.cacheHealth');
  ...
  const unitSiteHipcamp = snapshotInventory?.unitSiteCountHipcamp ?? rowsScannedHipcamp;
  const unitSiteSage = snapshotInventory?.unitSiteCountSage ?? rowsScannedSage;
        ...
        <dl className="min-w-0 space-y-1 text-sm">
          ...
          {meta.present ? (
            <IndustryOverviewSnapshotCounts
              ...
              sources={{
                primaryLabel: 'Hipcamp',
                primaryCount: unitSiteHipcamp,
                secondaryLabel: 'Sage',
                secondaryCount: unitSiteSage,
              }}
