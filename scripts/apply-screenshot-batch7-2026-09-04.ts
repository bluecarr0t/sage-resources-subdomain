#!/usr/bin/env npx tsx
/**
 * Publish / reject the 16 in-progress screenshot properties (2026-09-04 batch 7).
 *
 * Usage:
 *   npx tsx scripts/apply-screenshot-batch7-2026-09-04.ts
 *
...
const MIGRATIONS = [
  {
    name: 'Reject screenshot batch7 ghosts',
    file: 'reject-screenshot-batch7-ghosts-2026-09-04.sql',
    where: `id IN (11040, 96, 11287, 82, 11111, 11113, 81, 103, 10980, 83, 11225, 97)`,
  },
  {
    name: 'Lakeview + Akumal',
    file: 'enrich-lakeview-akumal-2026-09-04.sql',
    where: `id IN (13068, 139)`,
  },
  {
    name: 'Beekse + Mawgan Porth',
    file: 'enrich-beekse-mawgan-2026-09-04.sql',
    where: `id IN (11124, 11247)`,
  },
] as const;
...
async function main() {
  ...
  try {
    ...
    console.log('Bavarian Forest Glamping sibling (expect published, untouched):');
