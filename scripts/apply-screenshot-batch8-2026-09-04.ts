#!/usr/bin/env npx tsx
/**
 * Publish / reject the 15 in-progress screenshot properties (2026-09-04 batch 8).
 *
 * Usage:
 *   npx tsx scripts/apply-screenshot-batch8-2026-09-04.ts
 *
...
const MIGRATIONS = [
  {
    name: 'Reject screenshot batch8 ghosts',
    file: 'reject-screenshot-batch8-ghosts-2026-09-04.sql',
    where: `id IN (11163, 11155, 55, 11132, 10996, 77, 84, 92, 11217, 50, 107)`,
  },
  {
    name: 'Roulotte + Cabanes als Arbres',
    file: 'enrich-roulotte-cabanes-2026-09-04.sql',
    where: `id IN (11300, 11175)`,
  },
  {
    name: 'Rübezahl + Haliburton Forest',
    file: 'enrich-rubezahl-haliburton-2026-09-04.sql',
    where: `id IN (11037, 72)`,
  },
] as const;
...
async function main() {
  ...
  try {
    ...
    console.log('Bree Bosbeekpoort sibling (expect rejected, untouched):');
