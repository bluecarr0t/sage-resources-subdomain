...
const AMENITY_MAP: Record<string, string> = {
  ...
  'Cable Hookups': 'cable',
  // RV / parking / surface (expanded mappings)
...
const ACTIVITY_MAP: Record<string, string> = {
  ...
  'White-Water Rafting': 'whitewater_paddling',
  'Whitewater Rafting & Kayaking': 'whitewater_paddling',
  'Kite-Boarding': 'wind_sports',
  'Beer/Wine Tasting': 'alcohol_available',
...
function combineData(
  ...
  for (const site of sites) {
    ...
    const row: Record<string, unknown> = {
      ...
      alcohol_available: activityCols.alcohol_available ?? null,
      ...
      rv_vehicle_length: amenityCols.rv_vehicle_length ?? null,
      rv_parking: amenityCols.rv_parking ?? null,
      rv_accommodates_slideout: amenityCols.rv_accommodates_slideout ?? null,
      rv_surface_type: amenityCols.rv_surface_type ?? null,
      ...
      surfing: activityCols.surfing ?? null,
      horseback_riding: activityCols.horseback_riding ?? null,
      paddling: activityCols.paddling ?? null,
      climbing: activityCols.climbing ?? null,
      off_roading_ohv: activityCols.off_roading_ohv ?? null,
      boating: activityCols.boating ?? null,
      swimming: activityCols.swimming ?? null,
      wind_sports: activityCols.wind_sports ?? null,
      snow_sports: activityCols.snow_sports ?? null,
      whitewater_paddling: activityCols.whitewater_paddling ?? null,
      fall_fun: null,
