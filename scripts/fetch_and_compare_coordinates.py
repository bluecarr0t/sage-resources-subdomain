#!/usr/bin/env python3
"""
Fetch longitude and latitude for properties using Google Places API (New).
Compare fetched coordinates with existing values in the CSV.
"""
...
def search_place(api_key, property_name, city, state, address=None):
    ...
    Returns place data including coordinates.
    """
...
if __name__ == '__main__':
    csv_file = '/Users/nickharsell/Documents/Projects/sage-subdomain-marketing/csv/sage-glamping-sites.csv'
