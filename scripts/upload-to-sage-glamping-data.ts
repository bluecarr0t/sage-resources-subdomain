...
async function uploadData(
  ...
  for (let i = 0; i < data.length; i += BATCH_SIZE) {
    ...
    const csvToTableMapping: Record<string, string | null> = {
      ...
      'Google Phone Number': 'google_phone_number',
      'Google Website URI': 'google_website_uri',
      'Google Dine In': 'google_dine_in',
      'Google Takeout': 'google_takeout',
      'Google Delivery': 'google_delivery',
      'Google Serves Breakfast': 'google_serves_breakfast',
      'Google Serves Lunch': 'google_serves_lunch',
      'Google Serves Dinner': 'google_serves_dinner',
      'Google Serves Brunch': 'google_serves_brunch',
      'Google Outdoor Seating': 'google_outdoor_seating',
      'Google Live Music': 'google_live_music',
      'Google Menu URI': 'google_menu_uri',
      'Google Place Types': 'google_place_types',
      'Google Primary Type': 'google_primary_type',
      'Google Primary Type Display Name': 'google_primary_type_display_name',
      'Google Photos': 'google_photos',
      'Google Photos Count': null, // Skip - this is just metadata
      'Google Icon URI': 'google_icon_uri',
      'Google Icon Background Color': 'google_icon_background_color',
