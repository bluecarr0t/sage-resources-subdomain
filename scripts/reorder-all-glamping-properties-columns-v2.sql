...
-- duplicatenote is placed right after id
...
INSERT INTO "all_glamping_properties_new" (
  id, duplicatenote, property_name, slug,
  source, discovery_source, date_added, date_updated,
  property_type, site_name, unit_type,
  property_total_sites, quantity_of_units, unit_capacity, year_site_opened, operating_season_months, number_of_locations,
  ...
  ranch, beach, coastal, suburban, forest, field, wetlands, hot_spring, desert, canyon, waterfall, swimming_hole, lake, cave, redwoods, farm, river_stream_or_creek, mountainous, waterfront,
  food_on_site, restaurant, dog_park, clubhouse, alcohol_available, golf_cart_rental, private_bathroom, waterpark, kitchen, patio, electricity, general_store, cable, charcoal_grill, sewer_hook_up, electrical_hook_up, generators_allowed, water_hookup,
