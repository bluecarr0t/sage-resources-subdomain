...
export function migrateLegacySageAiChatModelId(id: string): string {
  if (id === 'openai/gpt-5-mini') return SAGE_AI_CHAT_DEFAULT_MODEL;
  if (id === 'openai/gpt-5-nano') return SAGE_AI_CHAT_DEFAULT_MODEL;
  if (id === 'openai/gpt-5.4-nano') return SAGE_AI_CHAT_DEFAULT_MODEL;
  if (id === 'anthropic/claude-opus-4.6') return SAGE_AI_CHAT_DEFAULT_MODEL;
  if (id === 'anthropic/claude-opus-4.7') return SAGE_AI_CHAT_DEFAULT_MODEL;
