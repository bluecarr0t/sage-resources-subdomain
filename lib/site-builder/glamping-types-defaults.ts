...
export const SITE_BUILDER_GLAMPING_TYPE_SEED_ROWS: SiteBuilderGlampingTypeSeedRow[] = [
  ...
  { slug: 'cabin-tent', name: 'Cabin Tent', default_sqft: 350, default_diameter_ft: null, cce_occupancy_code: null, default_quality_type: 'Premium' },
  { slug: 'canvas-cabin', name: 'Canvas Cabin', default_sqft: 400, default_diameter_ft: null, cce_occupancy_code: null, default_quality_type: 'Luxury' },
  ...
  { slug: 'tipi', name: 'Tipi', default_sqft: 250, default_diameter_ft: 18, cce_occupancy_code: null, default_quality_type: 'Premium' },
