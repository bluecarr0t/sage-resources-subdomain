 ...
 * Does not filter by property_type — Campground, RV Resort, Outdoor Boutique Hotel,
 * Ranch & Lodge, and Unknown stay indexable at /property/[slug] even when hidden from /map.
 */
