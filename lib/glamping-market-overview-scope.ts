...
export const GLAMPING_MARKET_SCOPE_EXCLUDED = [
  ...
  'Non-glamping unit types (RV pads, campsites, hotel rooms, suites, property buyouts)',
  'RV parks & resorts',
...
export const GLAMPING_MARKET_METHODOLOGY_NOTES = [
  'Cohort: published private commercial glamping properties in Sage research (see Included / Excluded). Inclusion is Sage-classified primarily-glamping product (is_glamping_property), not a hard unit-count floor in this snapshot; newer discovery targets multi-unit sites when inventory is verified.',
  ...
  'Brand rankings: avg. retail daily rate (ARDR) is the mean of each property’s published average rate within the brand, not the same as the national overview’s property-median ARDR. Non-glamping unit SKUs (RV pads, campsites, hotel rooms, suites, property buyouts) are excluded from brand unit and rate rollups.',
  ...
  'Last updated: The newest change anywhere in Sage’s research database.',
  'Use: for market sizing and benchmarking only, not financial, investment, lending, or appraisal advice.',
] as const;
